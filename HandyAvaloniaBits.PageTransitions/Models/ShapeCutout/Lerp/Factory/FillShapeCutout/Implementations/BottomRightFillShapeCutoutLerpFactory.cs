...
internal sealed class BottomRightFillShapeCutoutLerpFactory : AbstractFillShapeCutoutFactory
{
    public override LerpShapeCutout Create() => (in t) =>
    {
        var radius = LerpRadius(in t);
        return new(radius, 0, 0, radius, WindowBounds.Width, WindowBounds.Height);
    };
}
